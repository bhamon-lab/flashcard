...
Le [catalogue de progression](../curriculum/lycee-2026-2027.json) référence, pour chaque deck, la source officielle et ses rubriques. Il s’agit d’un choix éditorial de prérequis, pas d’un ordre imposé par les programmes.
...
| Deck | Cartes | Prérequis conseillés |
| --- | ---: | --- |
| [Second degré](../decks/maths/1re-spe-second-degre.json) | 13 | 2de · Équations, inéquations et signes, 2de · Fonctions de référence |
