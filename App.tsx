...
function StudyScreen({ deckId, newCardAllowance, onClose }: { deckId: number; newCardAllowance: number; onClose: () => void }) {
  ...
  if (loading || !deck) return <View style={styles.loading}><ActivityIndicator color={colors.blue} /></View>;
  if (!current) {
    return (
      <SafeAreaView style={styles.studyScreen} edges={['top', 'bottom']}>
        ...
        <View style={styles.completeWrap}>
          ...
          <View style={styles.completeActions}>
            ...
            <Pressable onPress={restartAllCards} style={styles.resetButton}><Ionicons name="refresh-outline" size={18} color={colors.blue} /><Text style={styles.resetButtonText}>Réinitialiser toutes les cartes</Text></Pressable>
